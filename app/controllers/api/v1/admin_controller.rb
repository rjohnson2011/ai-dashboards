    ...
    class AdminController < ApplicationController
      ...
      def debug_pr
        ...
        render json: {
          ...
          db_review_comments_count: (pr.pull_request_review_comments.count rescue "ERR"),
          db_review_comments_users: (pr.pull_request_review_comments.distinct.pluck(:user) rescue []),
          db_pr_comments_count: pr.pull_request_comments.count,
